...
@gen function birth(trace)
    ...
    σ₁ = 1/trace[:τ₁]
    σ₂ = 1/trace[:τ₂]
    hw1_μ = trace[(:μ,1)][hw1_index]
    hw2_μ = trace[(:μ,1)][hw2_index]
    hb_μ = trace[(:μb,1)][hb_index]
    ow_μ = trace[(:μ,2)][ow_index]
    ...
    #Calculate proposal score for new params
    ...
    q_forward = sum(hw1_score, hw2_score, hb_score, ow_score)
    q_backward = 1/previous_k
